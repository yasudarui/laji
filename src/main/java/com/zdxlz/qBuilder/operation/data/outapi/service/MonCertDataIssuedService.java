...
@Service
@Slf4j
public class MonCertDataIssuedService extends DataOutCascadeTradeAbs {

    public MonCertDataIssuedService() {
        this.bizMode = BizModeEnum.REPORT.getCode() ;
        this.bizType = BizTypeEnum.MON_CERT_DATA_REPORT.getCode();
    }

    public void collectCertData(MonCertData certData){
        CascadeReq cascadeReq = this.fetchTrade(certData);
