...
import com.zdxlz.qBuilder.api.report.RemoteReportDeviceOutService;
import com.zdxlz.qBuilder.common.core.constant.SecurityConstants;
import com.zdxlz.qBuilder.common.core.domain.report.entity.ReportDeviceCount;
 ...
 */
@Service
public class ReportDeviceService extends DataInCascadeTradeAbs {
    @Autowired
    private RemoteReportDeviceOutService remoteReportDeviceOutService;
    ...
    protected String bizProcess(CascadeReq cascadeReq) {
        ...
        List<ReportDeviceCount>  deviceCountDtoList = jsonObject.toJavaList(ReportDeviceCount.class);
        AjaxResult result = this.remoteReportDeviceOutService.reportDeviceCountOut(deviceCountDtoList, SecurityConstants.INNER);
